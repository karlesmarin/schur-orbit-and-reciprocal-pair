...
for r, LM in CFG:
    ...
    for k in ("cero", "no negativa", "no positiva", "MEZCLADA"):
        print("        %-14s : %d" % (k, cnt[k]))
    # La columna «one sign» de la tabla tab:virtual es la SUMA de las dos clases de signo unico, y
    # esta salida las tenia por separado sin sumarlas: el 2531 de la fila r=2 no era localizable en
    # ninguna corrida guardada.  Anadido el 19 de agosto de 2026.
