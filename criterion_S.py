...
from criterion_base import measure
...
def run():
    ...
    MIN = {}
    INCR = {}
    # Los TOTALES, anadidos el 19 de agosto de 2026.  El paper cita «190 443 formas en veinticuatro
    ...
    # visibles de la seccion de verificacion no eran localizables en ninguna corrida guardada.
    ...
    print()
    print("  TOTALES de la columna «ocupadas» --- las cifras que el paper cita y que esta tabla")
