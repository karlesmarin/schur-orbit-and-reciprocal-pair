...
| `_probe_bialt2.sage` | COSTE del bialternante contra .expand().   19 de agosto de 2026. | yes |
| `_probe_bialternante.sage` | EL BIALTERNANTE CONTRA .expand():  MISMO VALOR, OTRO COSTE.   19 de agosto de 2026. | yes |
...
| `_probe_gammaC.sage` | LAS DOS PROPUESTAS, verificadas antes de escribirlas.   16 de agosto de 2026. | -- |
...
| `_probe_par_forma.py` | SONDA: .QUE FORMA TIENE UNA COLUMNA LIBRE PAR?   19 de agosto de 2026. | yes |
| `_probe_quiralidad.py` | INTERROGATORIO DE LA QUIRALIDAD.  .Que es simetrico y que antisimetrico? | yes |
| `_probe_repl.sage` | .QUE MATA EXACTAMENTE UN .sage ALIMENTADO AL REPL?   19 de agosto de 2026. | -- |
...
| `a1_proof.py` | ============================================================================================ | yes |
| `affine_A_check.py` | ¿SE CUMPLE LA HIPOTESIS (A) DE LA ANALISIS PREVIO?  -- 15 de agosto de 2026. | yes |
...
| `check_e6.py` | EL CONTRAEJEMPLO A "e <= 4", CON NUESTRA PROPIA ANATOMIA.   16 de agosto de 2026. | yes |
...
| `galois_sign.sage` | EL SIGNO DE GALOIS DEL FILTRO.   16 de agosto de 2026.   (pasada previa, punto 6) | yes |
| `gamma_par.sage` | .SE CIERRA gamma_t TAMBIEN EN LA RAMA PAR?   16 de agosto de 2026.  (pasada previa, punto 7) | yes |
...
| `npp_calibrado_G2.py` | CALIBRAR EL INSTRUMENTO CONTRA EL EJEMPLO DE G2 DE NPP.   20 de agosto de 2026. | yes |
| `npp_cuatro_normalizaciones.py` | LAS CUATRO NORMALIZACIONES, a la vez.  Emparejar con corraiz o con raiz, y tomar d = orden en el | yes |
| `npp_elementos_regulares.py` | LOS ELEMENTOS REGULARES NO PRINCIPALES DE ORDEN PAR, EXPLICITOS Y VERIFICADOS.   20 de agosto de 2026. | yes |
...
| `npp_question81.py` | LA QUESTION 8.1 DE NPP, PROBADA CONTRA NUESTRA FAMILIA.   20 de agosto de 2026. | yes |
| `npp_question81.sage` | NUESTRO FILTRO CONTRA LA QUESTION 8.1 DE NADIMPALLI-PATTANAYAK-PRASAD.   16 de agosto de 2026. | yes |
| `npp_question81_v2.py` | QUESTION 8.1, CON EL INSTRUMENTO YA CALIBRADO --- Y EL EJE QUE EL G2 DE NPP NO PUEDE VER. | yes |
| `npp_tabla_valores.py` | LA TABLA COMPLETA DE sp_lambda(x_m), AUTOCONTENIDA.   20 de agosto de 2026. | -- |
...
| `odd_BD.sage` | EL IMPAR EN SU GRUPO:  B_{R'} -> B_{m'} x D_r,  la propuesta 3 de la reseña.   16 de agosto de 2026. | yes |
...
| `pII_orcid_datacite.py` | .LLEGA 2608.18302 A ORCID SOLO?  20 de agosto de 2026. | yes |
| `pII_verificar_publicado.py` | LO QUE LLEGO CONTRA LO QUE SALIO.  Paper II, arXiv 2608.18302. | yes |
| `pI_barrido_regla2.py` | REGLA 2: un instrumento nuevo barre TODO el catalogo el dia en que nace. | yes |
| `pI_instrument_asociadas.sage` | prob:instrument DEL PAPER I:  .es  m_mu = m_{mu*}  una identidad VISIBLE en tableaux? | yes |
| `pI_instrument_veredicto.sage` | prob:instrument --- VEREDICTO: el experimento con la regla de Littlewood es IMPOSIBLE, y la razon | yes |
| `pI_involucion_refinada.py` | LA INVOLUCION, AL NIVEL CORRECTO --- y .es L5 una relacion de Plucker? | yes |
| `pI_involucion_toggle.py` | EL EMPAREJAMIENTO AL NIVEL (mu,nu), DENTRO DE CADA EXPONENTE DE z --- su plan de manana, punto 1 | yes |
| `pI_laplace_antes_de_L5.py` | EL LADO DE LAPLACE, ANTES DE L5 --- y la condicion (4) de 41_IN, bien posada | yes |
| `pI_numerator_lift.py` | EL NUMERATOR LIFT  K_lambda = J_lambda x Omega_t  --- CONSTRUIDO, no descrito.  20 de agosto de 2026. | yes |
| `pI_problema2_composicion.py` | PROBLEMA 2 DEL PAPER I: .COMPONEN LOS DOS FORMALISMOS?   19 de agosto de 2026, noche. | yes |
| `pI_toggle_espacios_de_peso.py` | DONDE PUEDE VIVIR LA INVOLUCION: LOS ESPACIOS DE PESO DE K_lambda.   20 de agosto de 2026. | yes |
| `pI_toggle_esqueleto.py` | EL ESQUELETO FORZADO: QUE ELEMENTO DE K_lambda ES CADA MONOMIO DE LAPLACE.  20 de agosto de 2026. | yes |
| `pI_toggle_transversal_en_nu_omega.py` | .ESTA LA TRANSVERSAL EN (nu, omega)?   20 de agosto de 2026. | yes |
| `pI_tres_senos_porque.py` | .POR QUE TRES SENOS?  EL COLAPSO DEL ALTERNANTE, Y LAS DOS RAMAS COMO DOS SISTEMAS DE RAICES. | yes |
...
| `survivors_are_weyl.sage` | LOS SUPERVIVIENTES SON EL GRUPO DE WEYL, Y tau ES SU CARACTER SIGNO.   16 de agosto de 2026. | -- |
...
| `v28_witnesses.sage` | LOS TESTIGOS, verbatim.   16 de agosto de 2026. | yes |
| `v29_two_lemmas.sage` | LAS DOS PROPUESTAS, verificadas antes de escribirlas.   16 de agosto de 2026. | yes |
| `v2_formulas.py` | ============================================================================================ | yes |
...
| `_hoja_de_salida.py` | HOJA DE SALIDA DEL PAPER II --- «solo sale verdad confirmada».   19 de agosto de 2026. | yes |
