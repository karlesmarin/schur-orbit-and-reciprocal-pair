...
Four more follow the same line, from character values to the **ring they generate**, each with the
...
The last two are the newest. `segmento/` computes the ring of character values at the
